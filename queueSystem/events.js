...
export const CREATE_CUSTOM_QUEUE = 'create queue';
export const CREATE_CUSTOM_QUEUE_SUCCESS = 'create queue success';
export const CREATE_CUSTOM_QUEUE_FAIL = 'create queue fail';
